...
public class FSDirectory extends Directory {
  ...
  public void deleteFile(String name) throws IOException {
    File file = new File(directory, name);
//    System.out.println("FSDirectory.deleteFile() --> " + file.getAbsolutePath());
    if (!file.delete()) {
//        System.out.println("FSDirectory DELETE FAILED - "+ file.getAbsolutePath());
...
//    System.out.println("CREATING a new file in the directory, file = " + file.getAbsolutePath());
    return new FSIndexOutput(file);
  }

  /** Returns a stream reading an existing file. */
  public IndexInput openInput(String name) throws IOException {
//      System.out.println("OPENING file in the directory, file = " + new File(directory, name).getAbsolutePath());
...
class FSIndexInput extends BufferedIndexInput {
  ...
  public void close() throws IOException {
    if (!isClone) {
//        System.out.println("FSDirectory.close() CLOSING FILE = " + fileName);
        file.close();
    }
  }
...
class FSIndexOutput extends BufferedIndexOutput {
  ...
  public void close() throws IOException {
    super.close();
//    System.out.println("FSIndexOutput.close() --> CLOSING OUTPUT FILE " + fileName);
    file.close();
  }
