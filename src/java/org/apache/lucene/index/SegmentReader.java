...
class SegmentReader extends IndexReader {
  ...
  public String getSeg() { return segment;}
  ...
  public static SegmentReader get(Directory dir, SegmentInfo si,
   ...
   private void initialize(SegmentInfo si) throws IOException {
    ...
    //if (hasDeletions(si))
      //deletedDocs = /*DeletedBitSetsFactory.getDeletedBitSet(directory());*/new BitVector(directory(), segment + ".del");
  ...
  public boolean hasDeletions() {
    return (deletedDocuments != null && deletedDocuments.cardinality() > 0);
  }
  ...
  protected void doDelete(int docNum) {
    /*if (deletedDocs == null)
      deletedDocs = new BitVector(maxDoc());//new BitSet(maxDoc());
  ...
  public synchronized boolean isDeleted(int n) {
      return (deletedDocuments != null && deletedDocuments.get(n + this.deletedOffset));
  }
  ...
  public int numDocs() {
    ...
    if (deletedDocuments != null)
      n -= deletedDocuments.cardinality();
    return n;
  }
