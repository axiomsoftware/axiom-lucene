...
class SegmentTermDocs implements TermDocs {
  ...
  protected int count;
  protected int df;
  protected SynchronizedBitSet deletedDocs;
  ...
  protected SegmentTermDocs(SegmentReader parent) {
    ...
    this.deletedDocs = parent.deletedDocuments;
    this.deletedOffset = parent.deletedOffset;
  ...
  public boolean next() throws IOException {
    while (true) {
      ...
      if (deletedDocs == null || !deletedDocs.get(doc + this.deletedOffset))
        break;
      skippingDoc();
    }
    return true;
