...
public class MultiReader extends IndexReader {
  ...
  private boolean hasDeletions = true;
  ...
  */
  ...
  MultiReader(Directory directory, SegmentInfos sis, SynchronizedBitSet bitset, boolean closeDirectory, IndexReader[] subReaders) {
    super(directory, sis, closeDirectory);
    super.deletedDocuments = bitset;
    super.deletedOffset = 0;
    initialize(subReaders);
  }
  ...
  public boolean isDeleted(int n) {
      return (deletedDocuments != null && deletedDocuments.get(n));
  }
