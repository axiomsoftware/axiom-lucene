 ...
 * @version $rcs = ' $Id: Exp $ ' ;
 */
public final class IndexFileNames { /* changed to public so it can be used in other packages

  /** Name of the index segment file */
  public static final String SEGMENTS = "segments"; /* changed to public so it can be used in other packages
